...
/**
 * Caso de uso para generar reporte de cómics más reservados.
 * 
 * PRINCIPIOS DE CLEAN ARCHITECTURE:
 * - Responsabilidad única: solo genera reporte de reservas
 * - Delega la lógica de negocio al servicio de dominio
 * - Actúa como punto de entrada desde la capa de presentación
 */
public class GenerarReporteComicsMasReservadosCasoUso {
     ...
     */
    public GenerarReporteComicsMasReservadosCasoUso(IInventarioService inventarioService) {
    ...
    /**
     * Ejecuta el caso de uso para obtener los cómics más reservados.
     * 
     * @param limite Número máximo de cómics a retornar
     * @return Mapa de cómics y cantidad de reservas ordenados por reservas
     * @throws IllegalArgumentException si el límite es menor a 1
     */
    public Map<Comic, Long> ejecutar(int limite) {
        return inventarioService.obtenerComicsMasReservados(limite);
    }
}